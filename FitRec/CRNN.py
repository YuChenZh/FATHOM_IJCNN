...
def build_model(trainX,
                task_num,
                lstm_layer, drop, r_drop, l2_value, shared_layer,dense_num, n_labels,con_layer1,filter_len):
    """
    ...
    for i in range(0,task_num):
        ...
        locals()['cnn_out'+str(i)] = Convolution1D(nb_filter =con_layer1,filter_length = filter_len,activation='relu' )(locals()['input'+str(i)])
...
def main():
    ...
    model = build_model(trainX_list,task_num,lstm_layer, drop, r_drop, l2_value, shared_layer, dense_num, n_labels,con_layer1,filter_len)
   ...
   #===========================================================================================#
    ...
    file = open('time_cost/CRNN_1.txt', 'w')
