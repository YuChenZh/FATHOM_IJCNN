...
def build_model(trainX,
    ...
    for i in range(0,task_num):
        ...
        locals()['LSTM_layer2'+str(i)] = LSTM(dense_num,activation='relu',dropout=0.2,recurrent_dropout=0.2)(locals()['concate_layer'+str(i)])
...
def main():
    ...
    # attention_vectors = []
    # for i in range(300):
    #     attention_vector = np.mean(helper_funcs.get_activations(model,testX_list[0],
   ...
   #===========================================================================================#
    ...
    file = open('time_cost/FATHOM_40users.txt', 'w')
