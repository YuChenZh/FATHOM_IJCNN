...
def main():
   ...
   #===========================================================================================#
    ...
    file = open('time_cost/FATHOM.txt', 'w')
    ...
    for i in range(len(file_list_test)):
        ...
        locals()['Smape_PM25' + str(i)],locals()['mae_PM25' + str(i)] = helper_funcs.evaluation_single(locals()['test_X' + str(i)], locals()['test_y' + str(i)],
                                                            locals()['y_pred' + str(i + 1)],
                                                            look_back, n_columns, n_labels,
                                                            locals()['scaler_test' + str(i)], 0)
        locals()['Smape_PM10' + str(i)],locals()['mae_PM10' + str(i)] = helper_funcs.evaluation_single(locals()['test_X' + str(i)], locals()['test_y' + str(i)],
                                                            locals()['y_pred' + str(i + 1)],
                                                            look_back, n_columns, n_labels,
                                                            locals()['scaler_test' + str(i)], 1)
        locals()['Smape_NO2' + str(i)], locals()['mae_NO2' + str(i)] = helper_funcs.evaluation_single(locals()['test_X' + str(i)], locals()['test_y' + str(i)],
                                                           locals()['y_pred' + str(i + 1)],
                                                           look_back, n_columns, n_labels,
                                                           locals()['scaler_test' + str(i)], 2)
        locals()['Smape_CO' + str(i)],locals()['mae_CO' + str(i)] = helper_funcs.evaluation_single(locals()['test_X' + str(i)], locals()['test_y' + str(i)],
                                                          locals()['y_pred' + str(i + 1)],
                                                          look_back, n_columns, n_labels,
                                                          locals()['scaler_test' + str(i)], 3)
        locals()['Smape_O3' + str(i)],locals()['mae_O3' + str(i)] = helper_funcs.evaluation_single(locals()['test_X' + str(i)], locals()['test_y' + str(i)],
                                                          locals()['y_pred' + str(i + 1)],
                                                          look_back, n_columns, n_labels,
                                                          locals()['scaler_test' + str(i)], 4)
        locals()['Smape_SO2' + str(i)],locals()['mae_SO2' + str(i)] = helper_funcs.evaluation_single(locals()['test_X' + str(i)], locals()['test_y' + str(i)],
                                                           locals()['y_pred' + str(i + 1)],
                                                           look_back, n_columns, n_labels,
