...
def main():
    ...
    look_back = 15  # number of previous timestamp used for training
    ...
    testX_list = []
    testy_list = []
    file_list_train = glob.glob('../preprocessed_data/data_for_att/train/*.csv')
    file_list_test = glob.glob('../preprocessed_data/data_for_att/test/*.csv')
